...
let allHospitalPlaces = [
   ...
   , navTitle: "UPA Caxangá", location: "Avenida Caxangá, S/N (em frente ao nº 40 da Rua Ribeiro Pessoa) – Várzea Recife – PE", image: "https://www.hospitalmarialucinda.org/assets/images/unidades/principal-upa---caxanga-upa-caxanga-01.jpg", number: ["(81) 3184-4355"], email: ["admupacaxanga@fmsa.org.br"], latitude: 00, longitude: 00),
    HospitalModel(title: "Hospital Ulysses Pernambucano", ambulatorio: [""], emergencia: [""], clinica: [""], navTitle: "Ulisses Pernambucano", location: "Av. Conselheiro Rosa e Silva, 2130 - Tamarineira, Recife - PE, 52050-020", image: "", number: ["(81) 3182-9906"], email: [""], latitude: 00, longitude: 00),
    HospitalModel(title: "", ambulatorio: [""], emergencia: [""], clinica: [""], navTitle: "", location: "", image: "", number: [""], email: [""], latitude: 00, longitude: 00),
    HospitalModel(title: "", ambulatorio: [""], emergencia: [""], clinica: [""], navTitle: "", location: "", image: "", number: [""], email: [""], latitude: 00, longitude: 00),
    HospitalModel(title: "", ambulatorio: [""], emergencia: [""], clinica: [""], navTitle: "", location: "", image: "", number: [""], email: [""], latitude: 00, longitude: 00),
    HospitalModel(title: "", ambulatorio: [""], emergencia: [""], clinica: [""], navTitle: "", location: "", image: "", number: [""], email: [""], latitude: 00, longitude: 00)]
